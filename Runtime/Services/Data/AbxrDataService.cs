...
namespace AbxrLib.Runtime.Services.Data
{
    ...
    public class AbxrDataService
    {
        ...
        /// <summary>For testing only. Returns a copy of the pending event payloads.</summary>
        internal List<EventPayload> GetPendingEventsForTesting()
        {
            lock (_lock) return new List<EventPayload>(_eventPayloads);
        }

        /// <summary>For testing only. Returns a copy of the pending log payloads.</summary>
        internal List<LogPayload> GetPendingLogsForTesting()
        {
            lock (_lock) return new List<LogPayload>(_logPayloads);
        }

        /// <summary>For testing only. Returns a copy of the pending telemetry payloads.</summary>
