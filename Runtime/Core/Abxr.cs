...
public static class Abxr
{
	...
	public static string GetDeviceId() =>
		...
		ArborServiceClient.ServiceWrapper?.GetDeviceId();
#else
		"";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
		ArborServiceClient.ServiceWrapper?.GetDeviceSerial();
#else
		"";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetDeviceTitle();
#else
	    "";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetDeviceTags();
#else
	    null;
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetOrgId() ?? Configuration.Instance.orgID;
#else
	    "";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetOrgTitle();
#else
	    "";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetOrgSlug();
#else
	    "";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetMacAddressFixed();
#else
	    "";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetMacAddressRandom();
#else
	    "";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.IsConnected() && ArborServiceClient.ServiceWrapper.GetIsAuthenticated();
#else
	    false;
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetAccessToken();
#else
	    "";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetRefreshToken();
#else
	    "";
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetExpiresDateUtc() ?? DateTime.MinValue;
#else
	    DateTime.MinValue;
#endif
...
#if UNITY_ANDROID && !UNITY_EDITOR
	    ArborServiceClient.ServiceWrapper?.GetFingerprint();
#else
	    "";
#endif
}