 ...
 *
 * Serialized AbxrLib settings (Resources/AbxrLib.asset). Editor and custom inspectors
 * edit this type only. At runtime, values are copied into <see cref="Configuration"/>.
 */
