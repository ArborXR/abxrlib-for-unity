    ...
    public static class Logcat
{
    ...
    {
#if UNITY_EDITOR
        UnityEngine.Debug.Log($"{msg} {lineNumber} {memberName} {filePath} ");
#endif
    ...
    {
#if UNITY_EDITOR
        UnityEngine.Debug.LogWarning($"{msg} {lineNumber} {memberName} {filePath} ");
#endif
    ...
    {
#if UNITY_EDITOR
        UnityEngine.Debug.LogError($"{msg} {lineNumber} {memberName} {filePath} ");
#endif
