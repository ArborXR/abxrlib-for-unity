...
namespace AbxrLib.Runtime.UI.Examples
{
    ...
    public class CustomButtonExample : CustomButtonSystem
    {
        ...
        {
            Logcat.Info("CustomButtonExample - Start button clicked - Starting application");
        ...
        {
            Logcat.Info("CustomButtonExample - Settings button clicked - Opening settings");
        ...
        {
            Logcat.Info("CustomButtonExample - Exit button clicked - Exiting application");
        ...
        {
            Logcat.Info("CustomButtonExample - Help button clicked - Showing help");
        ...
        {
            Logcat.Info($"CustomButtonExample - Generic button '{buttonName}' clicked");
        ...
        public void ToggleFaceCamera()
        {
            ...
            Logcat.Info($"CustomButtonExample - Face camera toggled to {!currentSetting}");
