...
namespace Abxr.Runtime.Authentication
{
    ...
    public class Authentication : MonoBehaviour
    {
        ...
        private static void GetArborData()
        {
            ...
            _orgId = Core.AbxrCore.GetOrgId();
            _deviceId = Core.AbxrCore.GetDeviceId();
            _deviceTags = Core.AbxrCore.GetDeviceTags();
            try
            {
                var authSecret = Core.AbxrCore.GetFingerprint();
            ...
            _userId = Core.AbxrCore.GetAccessToken();
        }
        ...
        public static IEnumerator KeyboardAuthenticate(string keyboardInput = null)
        {
            ...
            Core.AbxrCore.PresentKeyboard(prompt, _authMechanism.type, _authMechanism.domain);
            _failedAuthAttempts++;
        }
        ...
        private static IEnumerator AuthRequest()
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Core.AbxrCore.onAuthCompleted?.Invoke(true, string.Empty);
            }
            else
            {
                ...
                _sessionId = null;
                Core.AbxrCore.onAuthCompleted?.Invoke(false, error);
            }
        }
