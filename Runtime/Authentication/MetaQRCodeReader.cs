...
namespace AbxrLib.Runtime.Authentication
{
    ...
    public class MetaQRCodeReader : MonoBehaviour
    {
        ...
        private void StartScanning()
        {
            ...
            if (webCamTexture == null || !webCamTexture.isPlaying || webCamRenderTexture == null)
            {
                Debug.LogError($"AbxrLib: Camera not ready for scanning. WebCamTexture: {webCamTexture != null}, isPlaying: {webCamTexture?.isPlaying}, RenderTexture: {webCamRenderTexture != null}");
                return;
            }
