...
namespace AbxrLib.Runtime.Authentication
{
    ...
    public class MetaQRCodeReader : MonoBehaviour
    {
        ...
        private static bool? _cachedDeviceSupported = null;
        ...
        private static bool IsDeviceSupported()
        {
            ...
            if (_cachedDeviceSupported.HasValue && deviceModel == _cachedDeviceModel)
            {
                return _cachedDeviceSupported.Value;
            }
