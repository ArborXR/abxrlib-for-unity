...
namespace AbxrLib.Runtime.AI
{
    ...
    /// </summary>
    private static IEnumerator SendPromptWithRetry(string json, string prompt, Action<string> callback)
    {
        int retryCount = 0;
        ...
        while (retryCount <= maxRetries && !success)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    lastError = HandleAINetworkError(request, retryCount, maxRetries);
    ...
    /// </summary>
    private static string HandleAINetworkError(UnityWebRequest request, int retryCount, int maxRetries)
    {
        string errorMessage = "";
    ...
    /// </summary>
    private static bool IsAIRetryableException(System.Exception ex)
    {
