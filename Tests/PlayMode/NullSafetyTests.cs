...
public class NullSafetyTests
{
    ...
    // Each test expects warnings from Abxr.X ("Not initialized yet."); warnings do not fail tests.
    ...
    public void StorageSetDefaultEntry_DoesNotThrow()
        => Assert.DoesNotThrow(() =>
            Abxr.StorageSetDefaultEntry(new System.Collections.Generic.Dictionary<string, string>(), Abxr.StorageScope.Device));
