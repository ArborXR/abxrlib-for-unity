...
namespace AbxrLib.Runtime.UI.Examples
{
    ...
    public class HandTrackingButtonExample : HandTrackingButtonSystem
    {
        ...
        {
            Logcat.Info("HandTrackingButtonExample - Start button activated by hand tracking - Starting application");
        ...
        {
            Logcat.Info("HandTrackingButtonExample - Settings button activated by hand tracking - Opening settings");
        ...
        {
            Logcat.Info("HandTrackingButtonExample - Exit button activated by hand tracking - Exiting application");
        ...
        {
            Logcat.Info("HandTrackingButtonExample - Help button activated by hand tracking - Showing help");
        ...
        {
            Logcat.Info($"HandTrackingButtonExample - Generic hand tracking button '{buttonName}' activated");
        ...
        public void ToggleFaceCamera()
        {
            ...
            Logcat.Info($"HandTrackingButtonExample - Face camera toggled to {!currentSetting}");
